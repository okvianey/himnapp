export const hymns = [
  {
    ...
    estrofas: {
      ...
      3: "¡Santo!, ¡Santo!, ¡Santo! la inmensa muchedumbre, De ángeles que cumplen tu santa voluntad, Ante ti se postra bañada de tu lumbre, Ante ti que has sido, que eres y serás.",
      4: "¡Santo!, ¡Santo!, ¡Santo! por más que estés velado, E imposible sea tu gloria contemplar; Santo tú eres solo y nada hay a tu lado, En poder perfecto, pureza y caridad.",
      5: "¡Santo!, ¡Santo!, ¡Santo! la gloria de tu nombre, Vemos en tus obras en cielo, tierra y mar. ¡Santo!   ¡Santo!   ¡Santo! te adora todo hombre, Dios en tres Personas, bendita Trinidad.Amén."
    }
  },
  {
    number: 2,
  ...
  },
  {
    ...
    coro: ["¡Aleluya! te alabamos", "¡oh, cuan grande es tu amor!", "¡Aleluya! te adoramos", "bendito Señor."]
  },
